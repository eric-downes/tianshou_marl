...
class TestFlexibleMultiAgentPolicyManager:
    ...
    def test_grouped_mode(self):
        ...
        policies = {
            "team_a": MockPolicy("team_a_policy"),
            "team_b": MockPolicy("team_b_policy")
        }
    ...
    def test_forward_with_shared_policy(self):
        ...
        batch = Batch(
            obs=Batch(
                agent_id=np.array(["agent_0", "agent_1", "agent_2", "agent_0", "agent_1", "agent_2"]),
