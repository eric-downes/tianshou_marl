...
class MinimalEnv:
    ...
    def step(self, actions):
        ...
        trunc = dict.fromkeys(self.agents, False)
...
class TestFlexiblePolicyFast:
    ...
    def test_custom_mode(self):
        ...
        env = MinimalEnv(n_agents=3)
        policies = {"policy_even": MinimalPolicy(), "policy_odd": MinimalPolicy()}
        ...
        manager = FlexibleMultiAgentPolicyManager(
            policies=policies, env=env, mode="custom", policy_mapping_fn=custom_mapping
        )
    ...
    def test_policy_update(self):
        ...
        manager.policy_mapping = dict.fromkeys(env.agents, new_policy)
...
class TestDictObservationFast:
    ...
    def test_auto_preprocessor(self):
        ...
        obs_space = spaces.Dict({"feat": spaces.Box(-1, 1, (3,))})
        policy = MinimalPolicy()
    ...
    def test_tensor_conversion(self):
        ...
        obs_space = spaces.Dict(
            {"continuous": spaces.Box(-1, 1, (2,)), "discrete": spaces.Discrete(3)}
        )

        preprocessor = DictToTensorPreprocessor(obs_space)

        obs = {"continuous": torch.randn(1, 2), "discrete": torch.tensor([1])}
    ...
    def test_box_space_extraction(self):
        ...
        obs_space = spaces.Dict({"box": spaces.Box(-1, 1, (4,))})
    ...
    def test_discrete_space_extraction(self):
        ...
        obs_space = spaces.Dict({"discrete": spaces.Discrete(5)})
    ...
    def test_multi_discrete_extraction(self):
        ...
        obs_space = spaces.Dict({"multi": spaces.MultiDiscrete([2, 3, 4])})
    ...
    def test_batched_processing(self):
        ...
        obs_space = spaces.Dict(
            {"feat1": spaces.Box(-1, 1, (2,)), "feat2": spaces.Box(-1, 1, (3,))}
        )

        preprocessor = DictToTensorPreprocessor(obs_space)

        batch_size = 4
        obs = {"feat1": torch.randn(batch_size, 2), "feat2": torch.randn(batch_size, 3)}
    ...
    def test_wrapper_forward(self):
        ...
        obs_space = spaces.Dict({"state": spaces.Box(-1, 1, (2,))})
        policy = MinimalPolicy()
...
class TestTrainingCoordinationFast:
    ...
    def test_sequential_trainer(self):
        ...
        trainer = SequentialTrainer(
            policy_manager=manager, agent_order=["agent_2", "agent_0", "agent_1"]
        )
    ...
    def test_self_play_trainer(self):
        ...
        trainer = SelfPlayTrainer(
            policy_manager=manager, main_agent_id="agent_0", snapshot_interval=10
        )
    ...
    def test_training_frequency(self):
        ...
        trainer = SimultaneousTrainer(
            policy_manager=manager, agent_train_freq={"agent_0": 1, "agent_1": 2}
        )
...
class TestCTDEFast:
    ...
    def test_global_state_concat(self):
        ...
        constructor = GlobalStateConstructor(mode="concatenate", obs_dim=2, n_agents=3)
    ...
    def test_global_state_mean(self):
        ...
        constructor = GlobalStateConstructor(mode="mean", obs_dim=2, n_agents=3)
    ...
    def test_qmix_init(self):
        ...
        from tianshou.algorithm.multiagent import QMIXMixer, QMIXPolicy
