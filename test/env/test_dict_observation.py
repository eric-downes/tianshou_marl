...
class TestDictObservationWrapper:
    ...
    def test_wrapper_initialization(self):
        ...
        env = MockDictEnv()
        policy = MockPolicy(observation_space=env.observation_space, 
    ...
    def test_forward_with_batched_dict_obs(self):
        ...
        batch_obs = {
            key: np.stack([obs1[key], obs2[key]]) 
...
class TestDictToTensorPreprocessor:
    ...
    def test_discrete_space_extractor(self):
        ...
        space = spaces.Dict({
            "discrete_feature": spaces.Discrete(10)
        })
        preprocessor = DictToTensorPreprocessor(space)
    ...
    def test_forward_single_observation(self):
        ...
        obs_tensors = {
            ...
            "discrete_state": torch.tensor([obs["discrete_state"].item() if hasattr(obs["discrete_state"], 'item') else obs["discrete_state"]]),
